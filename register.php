...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if ($result){
    ...
    if($num>0){
      ...
      $sql = "INSERT INTO `users` (firstname, lastname,username, email, password) VALUES ('$firstname', '$lastname','$username', '$email', '$password_hash')";
      $result = mysqli_query($conn, $sql);
...
<body>
  ...
  <div class="container">
    ...
    <form action="register.php" method="post">
      ...
      <input class="text" type="text" placeholder="Username" name="username" id="name" required>
  ...
  <p>aready a member <a href="login.php">Login</a></p>
</body>
